...
#creating a plot to view our traffic data 
...
#creating a plot to view our impaired water data 

ggplot(CAES_data, aes(x = `Imp. Water Bodies` )) +
  geom_boxplot(fill = "steelblue", color = "white") +
  labs(title = "Boxplot of Impaired Water Bodies", x = "Values", y = "Frequency") +
  theme_minimal()